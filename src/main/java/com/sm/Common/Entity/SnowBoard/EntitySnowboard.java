...
public class EntitySnowboard extends Entity
{
...
public static void registerEntity(){
		...
		createEntity(EntitySnowboard.class, "Snowboard", 0xDEF22C, 0x707070);
...
private static void createEgg(int randomId, int solidColor, int spotColor){
	...
	public EntitySnowboard(World worldIn, String string)
	{
		super(worldIn);
