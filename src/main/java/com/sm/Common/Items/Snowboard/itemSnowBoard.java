...
public class itemSnowBoard extends Item
{
		public itemSnowBoard()
		{
			...
			this.setTextureName("sm" + ":" + getUnlocalizedName());
		}
			...
			else
			{
				...
				else
				{
					if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
					{
						...
						EntitySnowboard robot = new EntitySnowboard(world, stack.getDisplayName());
						...
						if (!world.getCollidingBoundingBoxes(robot, robot.boundingBox.expand(-0.1D, -0.1D, -0.1D)).isEmpty())
						{
							return stack;
						}
